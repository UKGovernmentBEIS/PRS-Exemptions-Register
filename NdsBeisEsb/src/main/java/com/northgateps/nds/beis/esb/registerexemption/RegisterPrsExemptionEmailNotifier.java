...
/**
 * Sends an email to registered email address after registering an exemption
 * 
 */
public class RegisterPrsExemptionEmailNotifier
    ...
    public HashMap<String, Object> doEmailRequestProcess(RegisterPrsExemptionNdsRequest request,
        ...
        logger.info("Successfully set parameters in register exemption email template");
