 ...
 * 
 */
public class PrsExemptionUpdateLookupIdAdapter extends RetrieveAccountIdLdapAdapter<UpdateExemptionDetailsNdsRequest, UpdateExemptionDetailsNdsResponse> {

	@SuppressWarnings("unused")
	private static final NdsLogger logger = NdsLogger.getLogger(PrsExemptionUpdateLookupIdAdapter.class);
