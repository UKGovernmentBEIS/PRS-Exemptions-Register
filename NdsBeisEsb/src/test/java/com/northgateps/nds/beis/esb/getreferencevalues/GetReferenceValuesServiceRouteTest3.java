...
public class GetReferenceValuesServiceRouteTest3 extends CamelSpringTestSupport {

    private static final NdsLogger LOGGER = NdsLogger.getLogger(GetReferenceValuesServiceRouteTest3.class);
