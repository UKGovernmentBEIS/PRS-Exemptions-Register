...
Scenario: Process exemption text details
	...
	And I will receive "You must either upload a file or enter details" as validation message 	
	
    #Select file of wrong type
    Given I select a file "testProperties.json" with an incorrect file type
    Then I will remain on the personalised-exemption-text page
    And I will receive "You must upload a file that is one of the listed types" as validation message
    ...
    Then I will remain on the personalised-exemption-text page
    And I will receive "The file you are trying to upload exceeds the maximum size allowed" as validation message
    ...
    Then I will remain on the personalised-exemption-text page
    And the file "test.docx" will be uploaded
    ...
    Then I will remain on the personalised-exemption-text page
    And the document "test.docx" is not listed as uploaded
