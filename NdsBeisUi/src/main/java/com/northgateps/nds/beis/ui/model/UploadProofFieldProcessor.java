 ...
 *
 */
public class UploadProofFieldProcessor extends NullFieldProcessor {

    public UploadProofFieldProcessor() {
    }

    @Override
    public List<String> getPaths(String sourcePath) {
        return Arrays.asList(new String[] { "exemptionDetails.epcEvidenceFiles" });
    }
}
