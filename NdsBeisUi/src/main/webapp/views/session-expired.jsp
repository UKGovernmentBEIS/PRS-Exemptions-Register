...
<fmt:message bundle="${FieldsBundle}" key="Title_session_expired" var="title" />
	...
	<nds:form id="pageForm" method="post">
		...
		<main id="content" role="main"> 
	        ...
	        <h1 class="form-title heading-large">
	        	<fmt:message bundle="${FieldsBundle}" key="Heading_session_expired" />
	        </h1>
	        <p>
	        	<fmt:message bundle="${FieldsBundle}" key="Paragraph_session_expired" />
	        	<br/>
