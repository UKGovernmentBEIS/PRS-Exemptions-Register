...
<fmt:message bundle="${FieldsBundle}" key="Title_session_exception" var="title" />
...
<head data-nds-version="${version}">
	...
	<!--[if gt IE 8]><!-->
	<link
		href="${contextUi}/assets/stylesheets/sass_css/govuk-template${minify}.css?version=${version}"
	...
	<link
		href="${contextUi}/assets/stylesheets/sass_css/govuk-template-print${minify}.css?version=${version}"
	...
	<!--[if IE 8]>
	    ...
	    <![endif]-->
	<!--[if gte IE 9]><!-->
	<link href="${contextUi}/assets/stylesheets/fonts${minify}.css?version=${version}"
	...
	<!--[if gt IE 8]><!-->
	<link href="${contextUi}/assets/stylesheets/sass_css/govuk-elements${minify}.css?version=${version}" media="screen" rel="stylesheet" />
	<!--<![endif]-->
	...
	<nds:form id="pageForm" method="post">
		...
		<main id="content" role="main"> 
	        ...
	        <h1 class="form-title heading-large">
	        	<fmt:message bundle="${FieldsBundle}" key="Heading_session_exception" />
	        </h1>
	        <p>
	        	<fmt:message bundle="${FieldsBundle}" key="Paragraph_session_exception" />
	        	<br/>
	        	<fmt:message bundle="${FieldsBundle}" key="link_log_in_again">
	        		<fmt:param value="personalised-dashboard?tenant=${command.tenant}" />
	        	</fmt:message>
	        </p>
		</main>
